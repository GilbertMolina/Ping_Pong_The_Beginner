...
public class InstruccionesView extends View {
    public static float dificultaEstablecidaPractica = 7f;
    ...
    private float ball_x_velocity = dificultaEstablecidaPractica;
    private float ball_y_velocity = dificultaEstablecidaPractica;
    ...
    public InstruccionesView(Context context) {
        super(context);
    }

    public InstruccionesView(Context context, AttributeSet attrs){
        super(context, attrs);
    }

    public InstruccionesView(Context context, AttributeSet attrs, int defStyle){
    ...
    protected void onDraw(Canvas canvas) {
        ...
        opponent_color.setARGB(255, 255, 255, 255);
    ...
    private void physics() {
        ...
        setPlayerPaddle();
        setOpponentPaddle();
        if (ball_x_velocity > -dificultaEstablecidaPractica + 15 && ball_x_velocity < dificultaEstablecidaPractica + 15){
    ...
    private void setOpponentPaddle() {
        ...
        opponent_paddle.set(0, 0, getWidth(), 50);
    }
